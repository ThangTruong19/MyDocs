...
@NgModule({
    imports: [CommonModule, AppCommonModule, RouterModule.forChild([{ path: '', component: CustomizeRequestStatusListComponent }])],
    declarations: [CustomizeRequestStatusListComponent],
    providers: [CustomizeRequestStatusListService],
})
