...
export class ScrollLoadDirective {
    ...
    private _autoLoad() {
        ...
        const pageCount: number = parseInt(this.params.pageCount, 10) + parseInt(this.params.pageAdditionalCount, 10);
    ...
    private _concatList() {
        ...
        if (
            parseInt(this.params.pageCount, 10) + parseInt(this.params.pageAdditionalCount, 10) <
            _p.lastIndexList + _p.autoLoadCount
        ) {
            endIndex = parseInt(this.params.pageCount, 10) + parseInt(this.params.pageAdditionalCount, 10);
        } else {
