 ...
 */
@Component({
  selector: 'app-cs-request-resend-confirm',
  templateUrl: './cs-request-resend-confirm.component.html',
  styleUrls: ['./cs-request-resend-confirm.component.scss']
})
export class CsRequestResendConfirmComponent implements OnInit {
  @Input()
