...
import { FlagConditionEditComponent } from './flag-condition-edit.component';
...
describe('FlagConditionEditComponent', () => {
  let component: FlagConditionEditComponent;
  let fixture: ComponentFixture<FlagConditionEditComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [FlagConditionEditComponent],
  ...
  beforeEach(async(() => {
    fixture = TestBed.createComponent(FlagConditionEditComponent);
    component = fixture.componentInstance;
    flagConditionService = fixture.debugElement.injector.get(
      FlagConditionService
    );
    flagConditionService.fetchInitNew().then(res => {
      spyOn(FlagConditionService, 'fetchInitEdit').and.returnValue(
        Promise.resolve(res)
      );
    });
  ...
  it('ページタイトルが正しく表示されること', async(() => {
    fixture.whenStable().then(() => {
      ...
      expect(titleEl.innerHTML).toEqual('フラグ条件設定管理　変更');
    });
  }));
});
