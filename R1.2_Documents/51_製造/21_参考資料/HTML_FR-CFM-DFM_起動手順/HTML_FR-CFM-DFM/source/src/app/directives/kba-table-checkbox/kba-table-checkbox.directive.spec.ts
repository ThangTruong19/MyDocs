...
import { KbaTableCheckboxDirective } from './kba-table-checkbox.directive';
...
class KbaTableCheckboxDirectiveTestComponent {
  selectedList: any[] = [];
  data: any[] = ['1', '2', '3'];
  checkAll = false;
...
describe('KbaTableCheckboxDirective', () => {
  let component: KbaTableCheckboxDirectiveTestComponent;
  let fixture: ComponentFixture<KbaTableCheckboxDirectiveTestComponent>;
  let checkAllEl: any;
  let checkboxEl1: any;
  let checkboxEl2: any;
  let checkboxEl3: any;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [
        KbaTableCheckboxDirectiveTestComponent,
        KbaTableCheckboxDirective,
      ],
    }).compileComponents();
    fixture = TestBed.createComponent(KbaTableCheckboxDirectiveTestComponent);
