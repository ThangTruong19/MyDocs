...
import { KbaAuthoritySelectCheckboxDirective } from './kba-authority-select-checkbox.directive';
...
@Component({
  template: `
    ...
    <div>
      <input
        (appKbaAuthoritySelectCheckbox)="onChange($event)"
...
class KbaAuthoritySelectCheckboxDirectiveTestComponent {
  selectedList: any[] = [];
  data: any[] = ['1', '2', '3'];
  checkAll = false;
...
describe('KbaAuthoritySelectCheckboxDirective', () => {
  let component: KbaAuthoritySelectCheckboxDirectiveTestComponent;
  let fixture: ComponentFixture<
    KbaAuthoritySelectCheckboxDirectiveTestComponent
  >;
  let checkAllEl: any;
  let checkboxEl1: any;
  let checkboxEl2: any;
