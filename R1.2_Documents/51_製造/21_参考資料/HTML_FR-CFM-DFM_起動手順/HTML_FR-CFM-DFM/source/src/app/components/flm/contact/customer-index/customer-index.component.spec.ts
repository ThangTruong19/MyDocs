...
import { ContactCustomerIndexComponent } from './customer-index.component';
...
describe('ContactCustomerIndexComponent', () => {
  let component: ContactCustomerIndexComponent;
  let fixture: ComponentFixture<ContactCustomerIndexComponent>;
  let el: HTMLElement;
  let de: DebugElement;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ContactCustomerIndexComponent],
      imports: [
        KbaSidemenuModule,
        HttpClientModule,
        KbaAccordionModule,
  ...
  beforeEach(async(() => {
    fixture = TestBed.createComponent(ContactCustomerIndexComponent);
  ...
  it('should display initial value', () => {
    ...
    el = de.nativeElement;
    expect(el.innerHTML).toEqual('連絡先管理　紐付け一覧');
  });
