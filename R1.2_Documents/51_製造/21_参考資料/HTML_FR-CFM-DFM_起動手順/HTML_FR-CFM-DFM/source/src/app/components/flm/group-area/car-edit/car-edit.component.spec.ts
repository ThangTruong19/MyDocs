...
import { GroupAreaCarEditComponent } from './car-edit.component';
...
describe('GroupAreaEditComponent', () => {
  let component: GroupAreaCarEditComponent;
  let fixture: ComponentFixture<GroupAreaCarEditComponent>;
  let el: HTMLElement;
  let de: DebugElement;

  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [GroupAreaCarEditComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(GroupAreaCarEditComponent);
  ...
  it('should display initial value', async(() => {
    fixture.whenStable().then(() => {
      ...
      el = de.nativeElement;
      expect(el.innerHTML).toEqual('エリア管理 車両毎エリア変更');
    });
  }));
});
