...
@Component({
  selector: 'app-kba-authority-select-modal',
  templateUrl: './kba-authority-select-modal.component.html',
  styleUrls: ['./kba-authority-select-modal.component.scss'],
})
export class KbaAuthoritySelectModalComponent implements OnInit {
